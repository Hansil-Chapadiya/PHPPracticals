...
<body>
    ...
    <div class="container mt-2" style="border: 2px solid blue;">
        <div class="d-flex justify-content:center mb-3">
            <label class="display-3">Authentication Using Cookies</label>
        </div>
        <div class="mb-3">
...
<?php
    if (isset($_REQUEST['submit'])) {
        ...
        setcookie('uname',$_REQUEST['uname'],time()*24);
        setcookie('pname',$_REQUEST['pname'],time()*24);
        $loc = "http://localhost/Hansil/Practical_4/MH3_1.php?uname=$uname&pname=$pname";
        header("location:$loc");
    }
?>